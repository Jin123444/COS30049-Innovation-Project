...
const images = [
  { id: '1', source: require('../assets/slidePic1.jpg') },
  { id: '2', source: require('../assets/slidePic2.png') },
  { id: '3', source: require('../assets/slidePic3.jpg') },
  ...
  return (
    <View style={styles.background}>
      ...
      <View style={styles.content}>
            ...
            <Text style={styles.paragraph}>8:00a.m -10: 00a.m,  2:00p.m – 4:00p.m (Monday to Sunday)</Text>
      </View>

      <View style={styles.content}>
            <Text style={styles.header}>Feeding Time</Text>
            <Text style={styles.paragraph}>9:00a.m-10: 00a.m, 3:00p.m – 4:00p.m.</Text>
      </View>

      <View style={styles.content}>
            <Text style={styles.header}>Contact</Text>
            <Text style={styles.paragraph}>082-618 325 / 082-618 324 (Semenggoh Wildlife Centre)</Text>
      </View>
