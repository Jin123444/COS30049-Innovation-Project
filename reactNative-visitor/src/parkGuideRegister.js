...
const validateForm=async()=>
{
  ...
  if(!repeatPassword)
    ...
    if (Object.keys(errors).length === 0) {
      try {
        const response = await fetch('http://172.17.31.174:5000/api/parkGuideRegister', {
          method: 'POST',
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        ...
        />
        {
            errors.fullname?<Text style={styles.errorText}>
        ...
        <View style={styles.registerAsParkGuideContainer}>
            ...
            <TouchableOpacity onPress={handleVisitorPress}>
